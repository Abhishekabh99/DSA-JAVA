...
class SameTree {
    ...
    // check if tree is same or not by preorder method
    ...
    // checking if 2 different trees are identical or not
    public static boolean isSame(TreeNode2 root1, TreeNode2 root2) {
        ...
        return checks(root1.left, root2.left) && checks(root1.right, root2.right);
    }
}
